...
class DonHangModel {
    ...
    private $tableDetail = 'chitietdonhang';

    public function __construct() {
        $this->db = db_connect();
    }

    // Tạo đơn hàng mới (trả về ID đơn hàng vừa tạo)
    public function create($data) {
        $sql = "INSERT INTO donhang 
            (IDNguoiDung, TenKhachHang, GioiTinh, SoDienThoai, DiaChiGiaoHang, PhuongThucThanhToan, GhiChu, TongTien, TrangThaiDonHang)
            VALUES (:IDNguoiDung, :TenKhachHang, :GioiTinh, :SoDienThoai, :DiaChiGiaoHang, :PhuongThucThanhToan, :GhiChu, :TongTien, :TrangThaiDonHang)";
    ...
    public function addDetail($orderId, $details) {
        $sql = "INSERT INTO {$this->tableDetail} (IDDonHang, IDThietBi, SoLuong, Gia)
