...
--
-- Host: 127.0.0.1
-- Generation Time: May 31, 2025 at 09:08 PM
...
(1, 'sdfgsdfg', 'fdgsdfg', 'technology', 1, '', 'published', '2025-05-31 19:19:45', NULL),
...
--
-- Table structure for table `congviecthatbai`
--

CREATE TABLE `congviecthatbai` (
  `ID` bigint(20) UNSIGNED NOT NULL,
  `UUID` varchar(255) NOT NULL,
  `KetNoi` text NOT NULL,
  `HangDoi` text NOT NULL,
  `TaiTrong` longtext NOT NULL,
  `NgoaiLe` longtext NOT NULL,
  `ThoiDiemThatBai` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Bảng ghi lại các công việc (jobs) bị lỗi trong hàng đợi';

--
-- Dumping data for table `congviecthatbai`
--

INSERT INTO `congviecthatbai` (`ID`, `UUID`, `KetNoi`, `HangDoi`, `TaiTrong`, `NgoaiLe`, `ThoiDiemThatBai`) VALUES
(1, 'uuid-apple-20250529-001', 'database', 'notifications', '{\"job\":\"SendShipmentNotification\",\"data\":{\"order_id\":1,\"user_id\":1,\"email\":\"nguyenvana@example.com\"}}', 'Lỗi cổng SMS: Dịch vụ không khả dụng', '2025-05-28 21:00:00');
...
--
-- Table structure for table `dexuatthietbichonguoidung`
--

CREATE TABLE `dexuatthietbichonguoidung` (
  `ID` bigint(20) UNSIGNED NOT NULL,
  `IDNguoiDung` bigint(20) UNSIGNED NOT NULL,
  `GiaGoc` decimal(15,2) NOT NULL,
  `GiaKhuyenMai` decimal(15,2) NOT NULL,
  `AnhThuNho` varchar(255) NOT NULL,
  `IDThietBi` bigint(20) UNSIGNED NOT NULL,
  `TenThietBi` varchar(255) NOT NULL,
  `TenLoaiThietBi` varchar(255) DEFAULT NULL,
  `NgayTao` timestamp NULL DEFAULT current_timestamp(),
  `NgayCapNhat` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `NgayXoa` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Bảng lưu các đề xuất thiết bị cá nhân hóa cho người dùng';

--
-- Dumping data for table `dexuatthietbichonguoidung`
--

INSERT INTO `dexuatthietbichonguoidung` (`ID`, `IDNguoiDung`, `GiaGoc`, `GiaKhuyenMai`, `AnhThuNho`, `IDThietBi`, `TenThietBi`, `TenLoaiThietBi`, `NgayTao`, `NgayCapNhat`, `NgayXoa`) VALUES
(1, 2, 33990000.00, 32990000.00, 'https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/iphone-15-pro-finish-select-202309-6-7inch-naturaltitanium?wid=5120&hei=2880&fmt=p-jpg&qlt=80&.v=1692845702708', 1, 'iPhone 15 Pro Max', 'iPhone', '2025-05-30 18:57:11', '2025-05-30 18:57:11', NULL),
(2, 2, 6190000.00, 5990000.00, 'https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/MTJV3?wid=1144&hei=1144&fmt=jpeg&qlt=90&.v=1694014871985', 5, 'AirPods Pro (thế hệ 2)', 'AirPods', '2025-05-30 18:57:11', '2025-05-30 18:57:11', NULL),
(3, 3, 27990000.00, 27990000.00, 'https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/macbook-air-silver-select-202402?wid=452&hei=420&fmt=jpeg&qlt=95&.v=1707414111288', 6, 'MacBook Air 13-inch M3', 'MacBook', '2025-05-30 18:57:11', '2025-05-30 18:57:11', NULL);
...
INSERT INTO `donhang` (`ID`, `IDNguoiDung`, `TenKhachHang`, `GioiTinh`, `SoDienThoai`, `DiaChiGiaoHang`, `PhuongThucThanhToan`, `GhiChu`, `TongTien`, `TrangThaiDonHang`, `NgayTao`, `NgayCapNhat`, `NgayXoa`) VALUES
(1, 1, 'Nguyễn Văn A', 'Nam', '0901111111', '123 Đường ABC, Quận 1, TP.HCM', 'Thẻ tín dụng', 'Khắc tên \"NVA\"', 33990000.00, 'Đang xử lý', '2025-05-29 03:30:00', '2025-05-29 03:30:00', NULL),
(2, 2, 'Trần Thị B', 'Nữ', '0902222222', '456 Đường XYZ, Quận Ba Đình, Hà Nội', 'Chuyển khoản ngân hàng', NULL, 68500000.00, 'Chờ xử lý', '2025-05-29 03:31:00', '2025-05-29 03:31:00', NULL),
(3, 3, 'Lê Văn C', 'Nam', '0903333333', '789 Đường DEF, Quận Hải Châu, Đà Nẵng', 'COD', 'Gọi trước khi giao', 24990000.00, 'Đã vận chuyển', '2025-05-30 03:32:00', '2025-05-30 03:32:00', NULL);
...
(1, 'iPhone', NULL, '2025-05-31 10:45:05', NULL, 'https://store.storeimages.cdn-apple.com/1/as-images.apple.com/is/store-card-13-iphone-nav-202502_GEO_US?wid=400&amp;amp;hei=260&amp;amp;fmt=png-alpha&amp;amp;.v=dW5XbHI1eDVpd01qWUU4bFRtWGZXMGIwbkQ3THNNRjRsZmFuY3ZnUksrQTA2bGFaODVwaytiT1psSXc2dlhUWUwyZnhVM3hmakh4cEVIbk1pcnBIRXFpaVlBSTdOOXplUDUwZUNmQnR2OUxuakp5ZFBaaHhUOUJXVGFwbk9vT2k', ''),
(2, 'Mac', NULL, '2025-05-31 01:19:26', NULL, 'https://store.storeimages.cdn-apple.com/1/as-images.apple.com/is/store-card-13-mac-nav-202503?wid=400&amp;hei=260&amp;fmt=png-alpha&amp;.v=M1Q3OGxnb1lBaHhqNjZ2OVRXZmx4VEpBUDFBeEhMZS9GUnNSYXdEd0hscisrUlZaSVRoWVYzU0Qra0FoTmUwNng2bitObzZwQzk4cEorV1dZdzhIazVVcFlOTkdoMWg4ZkdDS1ovMUlzcW8', ''),
...
--
-- Table structure for table `luocsuditru`
--

CREATE TABLE `luocsuditru` (
  `ID` int(10) UNSIGNED NOT NULL,
  `TenDiTru` varchar(255) NOT NULL,
  `Batch` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Bảng theo dõi lịch sử di trú cơ sở dữ liệu (migrations)';

--
-- Dumping data for table `luocsuditru`
--

INSERT INTO `luocsuditru` (`ID`, `TenDiTru`, `Batch`) VALUES
(1, '2025_05_28_100000_create_NguoiDung_table', 1),
(2, '2025_05_28_100100_create_LoaiThietBi_table', 1),
(3, '2025_05_28_100200_create_ThietBi_table', 1);

-- --------------------------------------------------------

--
-- Table structure for table `matruycapcanhan`
--

CREATE TABLE `matruycapcanhan` (
  `ID` bigint(20) UNSIGNED NOT NULL,
  `LoaiToken` varchar(255) NOT NULL COMMENT 'Loại thực thể sở hữu token (ví dụ: AppModelsNguoiDung)',
  `IDChuTheToken` bigint(20) UNSIGNED NOT NULL COMMENT 'ID của thực thể sở hữu token',
  `TenToken` varchar(255) NOT NULL,
  `Token` varchar(64) NOT NULL,
  `QuyenHan` text DEFAULT NULL COMMENT 'Các quyền của token (JSON hoặc chuỗi phân cách)',
  `LanCuoiSuDung` timestamp NULL DEFAULT NULL,
  `NgayHetHan` timestamp NULL DEFAULT NULL,
  `NgayTao` timestamp NULL DEFAULT current_timestamp(),
  `NgayCapNhat` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Bảng token truy cập cá nhân cho API';

--
-- Dumping data for table `matruycapcanhan`
--

INSERT INTO `matruycapcanhan` (`ID`, `LoaiToken`, `IDChuTheToken`, `TenToken`, `Token`, `QuyenHan`, `LanCuoiSuDung`, `NgayHetHan`, `NgayTao`, `NgayCapNhat`) VALUES
(1, 'AppModelsNguoiDung', 1, 'api_token', '1|abcdef1234567890abcdef1234567890abcdef1234567890ab', '[\"device:read\",\"order:create\"]', '2025-05-30 02:37:00', '2026-05-30 02:37:00', '2025-05-27 20:30:00', '2025-05-30 02:37:00');
...
(3, 'Lê Văn C', 'levanc@example.com', '2025-05-27 20:00:00', '$2y$10$hashedpasswordexampleAA', '789 Đường DEF, Quận Hải Châu, Đà Nẵng', '0903333333', 'Người dùng', NULL, '2025-05-30 18:57:11', '2025-05-30 18:57:11', NULL, 'Nam', 0.02, 7, 8, 250000000.00, 0.07);
...
CREATE TABLE `phienlamviec` (
  ...
  `TrinhDuyetNguoiDung` text DEFAULT NULL,
  `DuLieuTaiTrong` longtext NOT NULL,
  `HoatDongCuoi` int(11) NOT NULL COMMENT 'Unix timestamp hoặc số nguyên tương tự thể hiện hoạt động cuối',
  `NgayTao` timestamp NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Bảng lưu trữ thông tin phiên làm việc của người dùng';

--
-- Dumping data for table `phienlamviec`
--

INSERT INTO `phienlamviec` (`ID`, `IDNguoiDung`, `DiaChiIP`, `TrinhDuyetNguoiDung`, `DuLieuTaiTrong`, `HoatDongCuoi`, `NgayTao`) VALUES
('session_apple_20250529_001', 1, '192.168.0.101', 'Mozilla/5.0 (iPhone; CPU iPhone OS 17_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.0 Mobile/15E148 Safari/604.1', '', 1716969000, '2025-05-30 18:57:11');
...
--
-- Table structure for table `thanhtruot`
--

CREATE TABLE `thanhtruot` (
  `ID` bigint(20) UNSIGNED NOT NULL,
  `TieuDe` varchar(255) NOT NULL,
...
--
-- Dumping data for table `thanhtruot`
--

INSERT INTO `thanhtruot` (`ID`, `TieuDe`, `DuongDanHinhAnh`, `DuongDanLienKet`, `NgayTao`, `NgayCapNhat`, `NgayXoa`, `IsActive`, `SortOrder`) VALUES
(1, 'Khám phá iPhone 15 Pro', 'images/banners/iphone15_pro_banner.jpg', '/devices/category/iphone', '2025-05-30 18:57:11', '2025-05-30 18:57:11', NULL, 1, 0),
(2, 'MacBook Air M3 Mới', 'images/banners/macbook_air_m3_banner.jpg', '/devices/6', '2025-05-30 18:57:11', '2025-05-30 18:57:11', NULL, 1, 0),
(3, 'Apple Watch Series 9', 'images/banners/apple_watch_s9_banner.jpg', '/promotions/3', '2025-05-30 18:57:11', '2025-05-30 18:57:11', NULL, 1, 0);
...
--
-- Table structure for table `thietbidexuat`
--

CREATE TABLE `thietbidexuat` (
  `ID` bigint(20) UNSIGNED NOT NULL,
  `IDThietBi` bigint(20) UNSIGNED NOT NULL,
  `DiemSo` decimal(5,2) NOT NULL COMMENT 'Điểm số đánh giá/đề xuất cho thiết bị',
  `NgayTao` timestamp NULL DEFAULT current_timestamp(),
  `NgayCapNhat` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `NgayXoa` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Bảng các thiết bị được đề xuất chung';

--
-- Dumping data for table `thietbidexuat`
--

INSERT INTO `thietbidexuat` (`ID`, `IDThietBi`, `DiemSo`, `NgayTao`, `NgayCapNhat`, `NgayXoa`) VALUES
(1, 1, 95.00, '2025-05-30 18:57:11', '2025-05-30 18:57:11', NULL),
(2, 6, 92.50, '2025-05-30 18:57:11', '2025-05-30 18:57:11', NULL),
(3, 3, 88.00, '2025-05-30 18:57:11', '2025-05-30 18:57:11', NULL),
(4, 5, 85.00, '2025-05-30 18:57:11', '2025-05-30 18:57:11', NULL);
...
--
-- Indexes for table `congviecthatbai`
--
ALTER TABLE `congviecthatbai`
  ADD PRIMARY KEY (`ID`),
...
--
-- Indexes for table `dexuatthietbichonguoidung`
--
ALTER TABLE `dexuatthietbichonguoidung`
  ADD PRIMARY KEY (`ID`),
...
--
-- Indexes for table `luocsuditru`
--
ALTER TABLE `luocsuditru`
  ADD PRIMARY KEY (`ID`);

--
-- Indexes for table `matruycapcanhan`
--
ALTER TABLE `matruycapcanhan`
  ADD PRIMARY KEY (`ID`),
  ADD UNIQUE KEY `Token` (`Token`),
  ADD KEY `IDX_MaTruyCapCaNhan_ChuThe` (`LoaiToken`,`IDChuTheToken`),
  ADD KEY `FK_MaTruyCap_NguoiDung` (`IDChuTheToken`);
...
ALTER TABLE `phienlamviec`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `IDNguoiDung` (`IDNguoiDung`),
  ADD KEY `IDX_PhienLamViec_HoatDongCuoi` (`HoatDongCuoi`);
...
--
-- Indexes for table `thanhtruot`
--
ALTER TABLE `thanhtruot`
  ADD PRIMARY KEY (`ID`);
...
--
-- Indexes for table `thietbidexuat`
--
ALTER TABLE `thietbidexuat`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `IDThietBi` (`IDThietBi`);
...
--
-- AUTO_INCREMENT for table `congviecthatbai`
--
ALTER TABLE `congviecthatbai`
...
--
-- AUTO_INCREMENT for table `dexuatthietbichonguoidung`
--
ALTER TABLE `dexuatthietbichonguoidung`
...
--
-- AUTO_INCREMENT for table `luocsuditru`
--
ALTER TABLE `luocsuditru`
  MODIFY `ID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `matruycapcanhan`
--
ALTER TABLE `matruycapcanhan`
  MODIFY `ID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `thanhtruot`
--
ALTER TABLE `thanhtruot`
  MODIFY `ID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `thietbidexuat`
--
ALTER TABLE `thietbidexuat`
  MODIFY `ID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- Constraints for table `dexuatthietbichonguoidung`
--
ALTER TABLE `dexuatthietbichonguoidung`
  ADD CONSTRAINT `FK_DeXuatNguoiDung_NguoiDung` FOREIGN KEY (`IDNguoiDung`) REFERENCES `nguoidung` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_DeXuatNguoiDung_ThietBi` FOREIGN KEY (`IDThietBi`) REFERENCES `thietbi` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `matruycapcanhan`
--
ALTER TABLE `matruycapcanhan`
  ADD CONSTRAINT `FK_MaTruyCap_NguoiDung` FOREIGN KEY (`IDChuTheToken`) REFERENCES `nguoidung` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `phienlamviec`
--
ALTER TABLE `phienlamviec`
  ADD CONSTRAINT `FK_PhienLamViec_NguoiDung` FOREIGN KEY (`IDNguoiDung`) REFERENCES `nguoidung` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `thietbidexuat`
--
ALTER TABLE `thietbidexuat`
  ADD CONSTRAINT `FK_DeXuat_ThietBi` FOREIGN KEY (`IDThietBi`) REFERENCES `thietbi` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
