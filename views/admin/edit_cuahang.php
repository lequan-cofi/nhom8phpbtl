...
<head>
    ...
    <title>Sửa thông tin cửa hàng - Admin</title>
...
<body>
    <div class="container py-4">
        ...
        <div class="card">
            <div class="card-body">
                <form action="index.php?page=cuahang&action=edit&id=<?php echo $cuahang['id']; ?>" method="POST">
                    <div class="mb-3">
                        <label for="ten" class="form-label">Tên cửa hàng <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="ten" name="ten" 
                               value="<?php echo htmlspecialchars($cuahang['ten']); ?>" required>
                    </div>

                    <div class="mb-3">
                        <label for="diachi" class="form-label">Địa chỉ <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="diachi" name="diachi" 
                               value="<?php echo htmlspecialchars($cuahang['diachi']); ?>" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control" id="google_map" name="google_map" 
                               value="<?php echo htmlspecialchars($cuahang['google_map']); ?>"
